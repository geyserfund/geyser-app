...
- Validate the managed Recoverable Grant-only project-creation navigation and labels.
...
- Required pass scope:
  ...
  - `packages/testing/playwright/tests/projectCreation/managedRecoverableGrant.spec.ts`
