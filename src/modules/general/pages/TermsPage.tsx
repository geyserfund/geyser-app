...
const PROHIBITED_SITE_ACTIONS = [
  ...
  t("Don't spam. Don't distribute unsolicited or unauthorized advertising or promotional material, or any junk mail, spam, or chain letters."),
  t("Don't lie to people. Don't post information you know is false, misleading, or inaccurate. Don't do anything deceptive or fraudulent."),
  t(
...
const SYSTEM_ACTIONS = [
  ...
  t("Don't use any kind of software or device (whether it's manual or automated) to \"crawl\" or \"spider\" any part of the Site."),
  t("Don't take apart or reverse engineer any aspect of Geyser in an effort to access things like source code, underlying ideas, or algorithms."),
] as const

const CREATOR_REMEDIES = [
  t("They post an update that explains what work has been done, how funds were used, and what prevents them from finishing the project as planned"),
  t(
  ...
  t("They're able to demonstrate that they've used funds appropriately and made every reasonable effort to complete the project as promised"),
...
const FEE_ITEMS = [
  ...
  t('We will apply a +10% fee from any project that enlists into our Promotions Network, a portion of which goes automatically to the promoter.'),
  t(
...
const AMBASSADOR_EARNINGS_ITEMS = [
  ...
  t('Geyser reserves the right to withhold or revoke rewards in cases of suspected abuse or violation of these terms.'),
...
const CONTENT_LICENSE_ITEMS = [
  ...
  t("When we use the Content, we can make changes, like editing or translating it. You grant us the right to edit, modify, reformat, excerpt, delete, or translate any of your Content."),
  t(
  ...
  t("We're not responsible for mistakes in your Content. Geyser will not be liable for any errors or omissions in any Content."),
] as const

const OUR_RIGHTS_ITEMS = [
  ...
  t('We reserve the right to take any other actions related to the project that we deem necessary to ensure our compliance with applicable laws.'),
  t(
    ...
    <>
      ...
      >
        <CardLayout w="full" gap={3}>
          ...
          <Body fontWeight={600}>{t('Effective Date and Last Updated')}: {EFFECTIVE_DATE}</Body>
          <TermsParagraph>{t("This page explains our terms of use. When you use Geyser, you're agreeing to all the rules below.")}</TermsParagraph>
          <TermsParagraph>
            {t(
          ...
          <TermsParagraph>
            ...
            {t(". We may change these terms from time to time. If we do, we'll let you know about any material changes, either by notifying you on the Site or by sending you an email.")}
          </TermsParagraph>
        </CardLayout>
        ...
        <TermsSection title={t("Things You Definitely Shouldn't Do")}>
          <TermsParagraph>
            {t("Thousands of people use Geyser. We expect all of them to behave responsibly and help keep this a nice place. Don't do any of these things on the Site.")}
          </TermsParagraph>
          <TermsList items={PROHIBITED_SITE_ACTIONS} />
          <TermsParagraph>
            {t("We also need to make sure that the Site is secure and our systems function properly. So don't do any of these things - most of which boil down to 'don't mess with our system.'")}
          </TermsParagraph>
          <TermsList items={SYSTEM_ACTIONS} />
          <TermsParagraph>
            {t(
          ...
          <TermsParagraph>
            {t("Geyser reserves the right to delist any project from the Site and from Geyser's platform that does not conform to these Terms.")}
          </TermsParagraph>
        </TermsSection>
        ...
        <TermsSection title={t('How Project Donations and Rewards Work')}>
          ...
          <TermsList items={CREATOR_REMEDIES} ordered />
          <TermsParagraph>
            {t(
        ...
        <TermsSection title={t('How Funding Works')}>
          ...
          <TermsParagraph>
            <strong>{t('Third-Party Services')}</strong>: {t("Our platform may give users access to third-party on-ramp services that enable contributions in fiat. These services are operated by third-party providers, and we don't control, endorse, or take responsibility for their operations, terms, or policies.")}
          </TermsParagraph>
          <TermsParagraph>
            <strong>{t('No Warranties')}</strong>: {t("We don't guarantee the accuracy, reliability, legality, security, or availability of any on-ramp service. Users choose to engage with these services at their own discretion and risk.")}
          </TermsParagraph>
          <TermsParagraph>
            <strong>{t('Indemnification')}</strong>: {t("Users agree to indemnify and hold us harmless from any claims, losses, damages, liabilities, costs, or expenses arising from their use of on-ramp services, including but not limited to disputes with third-party providers, unauthorized transactions, or regulatory matters.")}
          </TermsParagraph>
          <TermsParagraph>
            <strong>{t('No Financial Responsibility')}</strong>: {t("We are not a financial institution and/or payment processor and/or money services business. We don't process, hold, or manage funds related to on-ramp transactions, and we can't be held responsible for any losses, fees, delays, chargebacks, or transaction failures.")}
          </TermsParagraph>
          <TermsParagraph>
            <strong>{t('User Due Diligence')}</strong>: {t("Users should carefully review any third-party on-ramp provider before initiating a transaction. It is the user's responsibility to review and accept the provider's terms and policies before proceeding with any transactions.")}
          </TermsParagraph>
          <TermsParagraph>
            <strong>{t('Using Banxa')}</strong>: {t("If users make fiat contributions through Banxa, they must review and accept Banxa's Customer Terms and Conditions before completing their transaction. Banxa operates independently, and its services are subject to its own policies.")}
          </TermsParagraph>
          <TermsParagraph>
            <strong>{t('Identity Verification with SumSub')}</strong>: {t("Users completing Know Your Customer (KYC) verification through SumSub must review and accept SumSub's Terms and Conditions before proceeding. We don't control SumSub's verification process and aren't responsible for their services and/or decisions.")}
          </TermsParagraph>
        </TermsSection>
        ...
        <TermsSection title={t('Our Fees')}>
          <TermsParagraph>{t("We will not collect any fees without giving you a chance to review and accept them. If our fees ever change, we'll announce that on our Site.")}</TermsParagraph>
          <TermsList items={FEE_ITEMS} />
        </TermsSection>

        <TermsSection title={t('Ambassador Earnings - Terms & Conditions')}>
          <TermsList items={AMBASSADOR_EARNINGS_ITEMS} />
        </TermsSection>
        ...
        <TermsSection title={t('Your Intellectual Property')}>
          ...
          <TermsList items={CONTENT_LICENSE_ITEMS} />
        </TermsSection>
        ...
        <TermsSection title={t('Propagation of information over relays')}>
          ...
          <TermsParagraph>
            {t('This means that your project and profile information will be broadcast to other Nostr Relays. You can check which Relays data is being broadcast to by checking your project settings.')}
          </TermsParagraph>
        </TermsSection>

        <TermsSection title={t('Our Rights')}>
          <TermsParagraph>
            {t('To ensure compliance with our Terms, protect the health and integrity of our system, and to help ensure that creators and backers enjoy a safe and secure environment, Geyser reserves these rights:')}
          </TermsParagraph>
          <TermsList items={OUR_RIGHTS_ITEMS} />
          <TermsParagraph>
            {t(
