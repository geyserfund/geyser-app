...
import { EntryForProjectFragment, ProjectEntryFragment } from '../../../../../../../../types'
...
export const Entries = forwardRef<HTMLDivElement>((_, ref) => {
  ...
  const { entries, unpublishedEntries } = useEntriesAtom()
  ...
  return (
    <BodySectionLayout ref={ref} title={t('Posts')}>
      <RenderEntries entries={[...entries, ...unpublishedEntries]} />
...
export const RenderEntries = ({ entries }: { entries: ProjectEntryFragment[] }) => {
