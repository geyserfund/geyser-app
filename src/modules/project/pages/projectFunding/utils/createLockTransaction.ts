 ...
 * import {
 *   createAndSignLockTransaction,
 *   broadcastTransaction,
 *   waitForTransactionReceipt,
 *   getCurrentGasPrice
 * } from './createLockTransaction'
 *
 * async function lockFundsInSwap() {
 *   try {
 *     // 1. Get current gas price for optimal transaction inclusion
 ...
 *       gasPrice: gasPrice * 11n / 10n, // 10% above current price for faster inclusion
 *     })
 *
