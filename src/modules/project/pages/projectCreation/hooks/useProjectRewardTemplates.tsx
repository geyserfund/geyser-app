...
import { RewardCategories, rewardTemplates } from '../utils/constants'
import { tagToRewardCategoryMapping } from '../utils/constants'
...
export const useProjectRewardTemplates = (selectedTags: Tag[]): RewardTemplateType[] => {
