...
export const CreationIllustrationCard = ({ title, description, image }: CreationIllustrationCardProps) => {
  return (
    <CardLayout w="full" key={title} spacing={4} justifyContent="space-between" alignItems="center">
      <Box height="auto" width="100%" maxWidth="200px" borderRadius="md" overflow="hidden" objectFit={'contain'}>
