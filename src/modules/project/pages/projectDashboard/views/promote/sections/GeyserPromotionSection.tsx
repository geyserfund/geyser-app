...
export const GeyserPromotionSection = () => {
  ...
  // Fetch Ambassador Network Promotion Contribution Stats using the generated hook
  ...
  const contributionSummary = formattedContributionAmount
    ? hasProjectPromotionContributions
      ? t('{{amount}} has been enabled through Ambassador Network promotions on this project so far.', {
