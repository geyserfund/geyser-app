...
import type { NewsletterPreferenceKey } from '@/shared/constants/newsletter.ts'
...
export type NewsletterSegmentId = (typeof NEWSLETTER_SEGMENTS)[number]['id'] & NewsletterPreferenceKey
