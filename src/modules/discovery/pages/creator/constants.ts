...
export const creatorMiniStories: CreatorMiniStory[] = [
  {
    ...
    subtitle: 'Lightning arcade where backers became characters, sponsors, and part of the game itself.',
    imageUrl:
  ...
  },
  {
    ...
    subtitle: 'A global legal-defense campaign for privacy, free speech, and open-source rights.',
    imageUrl:
  ...
  {
    title: 'WallAxe',
    subtitle: 'Portable Bitaxe mining kits making decentralized hashpower more accessible, one plug at a time.',
    imageUrl:
...
export const creatorPossibilities: CreatorPossibility[] = [
  {
    title: 'Documentary on Bitcoin Revolution in Peru',
    description:
      'Follow grassroots communities using Bitcoin in daily life and bring their stories to a global audience.',
    icon: FaFilm,
    iconColor: '#ff6b6b',
  ...
  {
    title: 'Bitcoin Builders Meetup Series in Lagos',
    description: 'Host monthly meetups that onboard newcomers and connect local founders, merchants, and educators.',
    icon: FaUsers,
    iconColor: '#34d399',
  ...
  {
    title: 'Podcast on Bitcoin Stories from Latin America',
    description: 'Publish long-form interviews with builders on the front lines and grow a loyal listener base.',
    icon: FaMicrophone,
    iconColor: '#ffd93d',
  ...
  {
    title: 'Bitcoin Education Bootcamp for University Students',
    description: 'Run practical workshops on self-custody, Lightning, and sovereignty skills for the next generation.',
  ...
  {
    title: 'Open-source Lightning Wallet Plugin for Merchants',
    description: 'Build a public tool that helps small businesses accept Bitcoin faster and with lower friction.',
    icon: FaCode,
    iconColor: '#00f5dc',
  ...
  {
    title: 'Bitcoin Graffiti Mural in London, UK',
    description: 'Fund a public art project that sparks conversation and turns city walls into cultural signal.',
    icon: FaPalette,
    iconColor: '#f472b6',
  ...
  {
    title: 'Neighborhood Bitcoin Hub in Nairobi',
    description: 'Create a local space for workshops, office hours, and collaboration around community-led adoption.',
    icon: FaBuilding,
    iconColor: '#a78bfa',
  ...
  {
    title: 'Crowdfunded Bitcoin Hardware Pilot in Brazil',
    description: 'Prototype and ship a first run with early supporters validating the concept in public.',
    icon: FaFlask,
    iconColor: '#f59e0b',
  ...
  {
    title: "Field Notes: A Creator's Guide to Circular Economies",
    description: 'Write and publish real playbooks from builders so others can launch faster with confidence.',
    icon: FaPenFancy,
    iconColor: '#fb923c',
