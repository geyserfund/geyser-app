    ...
    <>
      ...
      <VStack w="full" spacing={6} alignItems="stretch">
        <CardLayout w="full" gap={4}>
          ...
          <Body>{t('Contest window {{start}} to {{end}}', { start: TERMS_START, end: TERMS_END })}</Body>
        </CardLayout>
        ...
        <CardLayout w="full" gap={3}>
          ...
          <List spacing={2} pl={5}>
            <ListItem>
              <Body>{t('Only contributions made while logged in are eligible.')}</Body>
            </ListItem>
            <ListItem>
              <Body>{t('Contributions to your own projects do not count.')}</Body>
            </ListItem>
            <ListItem>
              <Body>{t('Score equals total eligible sats contributed during the contest window.')}</Body>
            </ListItem>
            <ListItem>
              <Body>{t('Winners are the top 3 contributors at the deadline.')}</Body>
            </ListItem>
          </List>
        </CardLayout>
        ...
        <CardLayout w="full" gap={3}>
          ...
          <List spacing={2} pl={5}>
            <ListItem>
              <Body>{t('Prize: one (1) VIP conference pass per winner.')}</Body>
            </ListItem>
            <ListItem>
              <Body>{t('Travel and accommodation are excluded unless explicitly stated otherwise.')}</Body>
            </ListItem>
            <ListItem>
              <Body>{t('Winners are contacted by email and/or inbox within 7 days after contest end.')}</Body>
            </ListItem>
            <ListItem>
              <Body>{t('Winners must respond within 72 hours to claim the ticket.')}</Body>
            </ListItem>
          </List>
        </CardLayout>
        ...
        <CardLayout w="full" gap={3}>
          ...
          <List spacing={2} pl={5}>
            <ListItem>
              <Body>{t('Refunded or chargeback-related contributions are excluded.')}</Body>
            </ListItem>
            <ListItem>
              <Body>{t('In score ties, earlier timestamp of reaching that score wins.')}</Body>
            </ListItem>
            <ListItem>
              <Body>{t('If still tied, lower user ID lexicographically wins.')}</Body>
            </ListItem>
            <ListItem>
              <Body>{t('One ticket per person.')}</Body>
            </ListItem>
          </List>
