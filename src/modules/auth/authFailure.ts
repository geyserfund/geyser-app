...
export const getAuthFailureMessage = (t: TFunction, code?: string, fallback?: string) => {
  switch (code) {
    ...
    case 'OAUTH_EMAIL_ALREADY_EXISTS':
      return t('An account already exists for this email. Sign in with email, then connect this provider.')
