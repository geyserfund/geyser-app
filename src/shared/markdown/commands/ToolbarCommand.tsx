...
export const ToolbarCommand = ({ name, cmd, label, Icon, isDisabled }: ToolbarCommandProps) => {
  const { runCommand, isActive, isDisabled: hasBeenDisabled } = useToolbarCommand(name, cmd)
