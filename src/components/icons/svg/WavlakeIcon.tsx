...
export const WavlakeIcon = ({ tilted = true, ...props }: IconProps & { tilted?: boolean }) => {
  return (
    <Icon
      version="1.0"
    ...
    >
      <svg>
        <g transform="translate(0.000000,17.000000) scale(0.100000,-0.100000)" fill="currentColor" stroke="none">
