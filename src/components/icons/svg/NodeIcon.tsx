  ...
  return (
    <Icon width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        ...
        fill="currentColor"
      />
      <circle cx="15" cy="8.04545" r="2.04545" stroke="currentColor" strokeWidth="2" />
      <circle cx="15" cy="21.9546" r="2.04545" stroke="currentColor" strokeWidth="2" />
      <circle cx="8.04545" cy="15" r="2.04545" stroke="currentColor" strokeWidth="2" />
      <circle cx="21.9546" cy="15" r="2.04545" stroke="currentColor" strokeWidth="2" />
    </Icon>
  )
}
