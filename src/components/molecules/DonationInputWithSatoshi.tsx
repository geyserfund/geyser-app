...
export const DonationInputWithSatoshi = ({className, onChange, name, inputGroup, amountSatoshi, onChangeSatoshi, value, ...rest}: IDonationInputWithSatoshiProps) => {
	...
	return (
		<InputGroup {...inputGroup}>
			...
			<Input value={ value } type="number" className={classNames(classes.inputElement, className)} onChange={handleInput} {...rest} placeholder="0" />
			<InputRightElement width="50px" >
				<Button className={classes.switchButtton} onClick={() => {
					console.log('checking onclick event');
					onChangeSatoshi(!amountSatoshi);
				}} variant="ghost">
					<BsArrowRepeat className={classes.switchIcon} />
					{
						amountSatoshi ? <BiDollar className={classes.insideIcon}/>
