...
export const discoveryRoutes = [
  ...
  getPath('discoveryCampaignsSuccessfullyFunded'),
  ...
  getPath('discoveryRecoverableGrantProjects'),
  getPath('discoveryRecoverableGrantProjectsLatest'),
  getPath('discoveryRecoverableGrantProjectsInYourRegion'),
  getPath('discoveryRecoverableGrantProjectsCategory', PathName.categoryName),
  getPath('discoveryRecoverableGrantProjectsSubCategory', PathName.subCategoryName),
  ...
  getPath('discoveryImpactFundsWorkshops'),
