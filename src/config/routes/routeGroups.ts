...
export const discoveryRoutes = [
  ...
  getPath('discoveryCircularGrantProjects'),
  getPath('discoveryCircularGrantProjectsLatest'),
  getPath('discoveryCircularGrantProjectsInYourRegion'),
  getPath('discoveryCircularGrantProjectsCategory', PathName.categoryName),
  getPath('discoveryCircularGrantProjectsSubCategory', PathName.subCategoryName),
