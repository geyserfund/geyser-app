...
import { getPath, NoContributionImageUrl } from '../../../../../constants'
...
const ContributionSummary = ({ funder, project }: ContributionSummaryProps) => {
  return (
    <CardLayout
      as={Link}
...
export const ProfileContributions = ({ contributions, isLoading }: ProfileContributionsProps) => {
  ...
  return (
    <ProfileTabLayout heading={t('Contributions')}>
