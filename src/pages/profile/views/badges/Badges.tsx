import { Button, HStack, Link as ChakraLink, Box } from '@chakra-ui/react';
...
export const Badges = ({ userProfile, isEdit, isLoading }: { userProfile: User; isEdit: boolean; isLoading: boolean }) => {
  ...
  return (
    <Box as="section" paddingY={{ base: '10px', lg: '20px' }}>
      <CardLayout noMobileBorder padding="0" spacing="20px">
