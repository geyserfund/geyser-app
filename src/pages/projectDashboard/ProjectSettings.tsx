...
import { HStack, Text, VStack, GridItem, InputGroup, Input, InputRightAddon, Image } from '@chakra-ui/react';
...
import { isMobileMode, useNotification, validateEmail, validLighteningAddress } from '../../utils';
			...
			<GridItem colSpan={8} display="flex" justifyContent="center">
				...
				>
					<VStack width="100%" alignItems="flex-start">
						...
						<ButtonComponent isLoading={updateLoading} primary isFullWidth onClick={handleNext}>Save</ButtonComponent>
					</VStack>
				</VStack>
			</GridItem>
