...
import { HStack, Text, useDisclosure, VStack, GridItem } from '@chakra-ui/react';
...
import { AddMilestones, defaultMilestone } from '../creation/projectCreate/components';
			...
			<GridItem colSpan={8} display="flex" justifyContent="center">
				...
				>
					<VStack w="100%" spacing="40px">
						...
						<VStack justifyContent="flex-start" alignItems="flex-start" width="100%" spacing="10px" paddingY="80px">
							...
							>
								...
								<VStack width="100%" alignItems="flex-start">
									...
									<Text wordBreak="break-all" color="brand.neutral700" fontSize="12px">{node?.connectionDetails.hostname}</Text>
								</VStack>

								<VStack width="100%" alignItems="flex-start">
									<Text color="brand.neutral700">Public key</Text>
									<Text wordBreak="break-all" color="brand.neutral700" fontSize="12px">{node?.connectionDetails.pubkey}</Text>
								</VStack>
								<VStack width="100%" alignItems="flex-start" flexWrap="wrap">
									<Text color="brand.neutral700">Invoice Macaroon</Text>
									<Text wordBreak="break-all">{node?.connectionDetails.macaroon}</Text>
								</VStack>
								<VStack width="100%" alignItems="flex-start">
									<Text color="brand.neutral700">TLS certificate</Text>
									<Text wordBreak="break-all" color="brand.neutral700" fontSize="12px">{node?.connectionDetails.tlsCertificate}</Text>
								</VStack>
								<VStack width="100%" alignItems="flex-start">
									<Text color="brand.neutral700">gRPC port</Text>
									<Text wordBreak="break-all" color="brand.neutral700" fontSize="12px">{node?.connectionDetails.grpcPort}</Text>
								</VStack>

							</VStack>}
							<Text color="brand.neutral700" fontSize="10px">If you want to change your node reach out to hello@geyser.fund</Text>
						</VStack>
					</VStack>
				</VStack>
			</GridItem>
