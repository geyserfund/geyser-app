...
export const ProjectFundingBanner = forwardRef<HTMLDivElement, Props>(({ title, banner, lnurlPayUrl }, ref) => {
  ...
  return (
    <>
      <img style={{ display: 'none' }} src={LogoDark} loading="eager" alt={'project-lnurl-pay-sharable-image'} />
      <Box w="100%">
        <Image objectFit="contain" src={banner} />
      </Box>
      <Box ref={qrRef ? ref : undefined} w="1500px" h="500px" position="absolute" opacity="0" fontSize="36px">
              ...
              >
                ...
                <Box display="flex" flexDirection="column" alignItems="center" flexWrap="nowrap">
                  <HStack align="center" justify="center">
                    ...
                    <Box>
                      <Text ml="0.2em" textAlign="center" fontWeight="bold" fontSize="1em" whiteSpace="nowrap">
                        {title}
                      </Text>
                    </Box>
                  </HStack>
