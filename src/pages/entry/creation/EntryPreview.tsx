...
import { defaultEntry } from '../../../modules/project/pages1/projectView/views/posts/editor'
import { CardLayout } from '../../../shared/components/layouts'
import { getPath } from '../../../shared/constants'
import { ProjectEntryValidations } from '../../../shared/constants'
...
export const EntryPreview = () => {
  ...
  if (loadingPosts || loading || !params.entryId) {
    return <Loader />
  }
