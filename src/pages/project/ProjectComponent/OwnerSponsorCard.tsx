...
export const OwnerSponsorCard = ({
  ...
  const podcast = projectDetails.blocks.find(
    (block) => block.key === 'podcast',
  );
    ...
    <>
      <Box>
        ...
        <VStack spacing="10px" w="100%">
          ...
          {problem && (
            <Text w="100%" fontSize="lg" fontWeight="medium">
              {problem}
            </Text>
          )}
        ...
        {podcast &&
        podcast.podcast &&
        podcast.podcast.includes('soundcloud') ? (
          <Box width="100%" mt={10}>
            <ReactPlayer
        ...
        <ModalContent>
          ...
          <ModalBody>
            <Text mb={5} fontWeight="medium">
              Lightning addresses and QR codes make it possible for anyone to
              fund projects from anywhere.
            </Text>
