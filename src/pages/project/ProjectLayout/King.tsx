...
export const King = ({ project }: { project: IProject}) => {
	...
	},
	{
		...
		blockType: 'UL',
		images: [project.media[1], project.media[2], project.media[3]],
	},
	{
		key: 'aboutMe',
		title: 'Who am I?',
	...
	const projectUpdates: IProjectUpdate[] = [
		...
		},
		{
			...
			images: [project.media[5], project.media[6], project.media[7]],
			type: 'PL',
		},
		{
