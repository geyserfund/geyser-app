...
},
{
	...
	title: 'Rewards',
	body: [
		'- **REWARD 1: Be part of the BFF Community** Price: $10 USD. Access to a monthly community call with hands-on information from the ground with Anita Posch and BFF participants.',
	],
	blockType: 'PL',
},
{
...
const projectName: string = 'bitcoin-for-fairness';
