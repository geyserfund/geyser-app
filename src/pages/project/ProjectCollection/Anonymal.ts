...
const projectBlocks: IProjectBlock[] = [
  {
    ...
    body: [],
    podcast:
      'https://soundcloud.com/user-44010708/geyser-podcast-007-annonymal?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing',
    blockType: 'PL',
  },
  {
    key: 'description1',
...
const projectDetails: IProjectDetail = {
  problem:
    'Anonymal wants to bring more people to bitcoin using modern heavy metal as a tool.',
  ...
  ownerIntro:
    'Anonymal is the first Modern Heavy Metal band to sing exclusively about Bitcoin history, philosophy and goals.',
