...
const projectBlocks: IProjectBlock[] = [
	...
	},
	{
		...
		body: [
			'1. **3000** - for pre-production: pay an orga helper for planning the travel and interview requests, for first local interviews, e.g. 21 Community, and a promo film to attract more investors. (First IV`s are for Geyser Blog.)',
			'2. **10.000** - to book flights and some accommodation, check for technical insurance ',
			'3. **15.000** - to fly over to the USA and prepare for the shooting, e.g. testhoots, technic rental, meet first iv partners',
			'4. **25.000** - all above including renting or buying our Bus ',
			'5. **From 70.000 to 100.000** - film 3 - 6 weeks in the USA to be able to pay material backup, insurance, the trip and renting the vehicle, the equipment and the team basics',
	...
	},
	{
		...
		body: [
			...
			'https://m.imdb.com/name/nm3479489/filmotype/assistant_director?ref_=m_nmfm_1',
			'https://www.crew-united.com/de/Daniela-Nela-Biedermann_683503.html',
			'**Awards**',
