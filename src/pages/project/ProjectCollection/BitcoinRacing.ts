...
const projectBlocks: IProjectBlock[] = [
  {
    ...
    body: [],
    podcast:
      'https://soundcloud.com/user-44010708/bitcoin-racing-008?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing',
    blockType: 'PL',
  },
  {
    key: 'description1',
    title:
      'The first race team in the world to be supported by a whole Nation: El Salvador ',
    body: [
...
const projectDetails: IProjectDetail = {
  ...
  ownerIntro:
    'BitcoinRacing was launched by a family and friends of Bitcoin and motorsports enthusiasts at the start of 2022',
  blocks: projectBlocks,
};

const projectName: string = 'bitcoinracing';
