...
const projectBlocks: IProjectBlock[] = [
  ...
  },
  {
    ...
    body: ['- App Design & UI', '- App Development', '- Backend Development'],
    blockType: 'PL',
  },
  {
    key: 'description9',
...
const projectDetails: IProjectDetail = {
  problem:
    'Bitcoin is a way of life. Bitcoiners share a lot of values and we all have been through the same journey, to meet a Bitcoiner is to meet an instant friend. Yet there’s no easy way for us to meet each other in real life.',
