...
const projectBlocks: IProjectBlock[] = [
  {
    ...
    body: [],
    podcast:
      'https://soundcloud.com/user-44010708/bitcoin-ballers?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing',
    blockType: 'PL',
  },
  {
    key: 'title1',
...
const projectDetails: IProjectDetail = {
  problem:
    'Increase awareness and understanding of money and Bitcoin, specifically relating to time, energy, value and responsibility.',
  ...
  ownerIntro:
    "I'm a former football trainee now looking to bring together football, Bitcoin and education.",
