...
const projectBlocks: IProjectBlock[] = [
  {
    ...
    body: [],
    podcast:
      'https://soundcloud.com/user-44010708/the-geyser-podcast-002?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing',
    blockType: 'PL',
  },
  {
    key: 'problem',
...
const projectDetails: IProjectDetail = {
  ...
  ownerIntro:
    'I’m a Junior Editor at Bitcoin Magazine with a passion for Bitcoin Education.',
