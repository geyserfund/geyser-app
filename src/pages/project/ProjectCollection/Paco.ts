...
const projectBlocks: IProjectBlock[] = [
  {
    ...
    body: [],
    podcast:
      'https://soundcloud.com/user-44010708/geyser-podcast-005-run-with-bitcoin?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing',
    blockType: 'PL',
  },
  {
    key: 'description1',
  ...
  },
  {
    ...
    body: [
      '2016',
      'I then went through Mexico, El Salvador, and Guatemala.I was a volunteer at a school in Guatemala for 3 weeks.',
    ],
    images: [4],
    blockType: 'PL',
  },
  {
    ...
    body: [
      '2017',
      'I was teaching English in Colombia, Dumpster Diving in Ecuador, and Selling peanuts in Peru.',
    ],
    images: [5],
    blockType: 'PL',
  },
  ...
  },
  {
    ...
    title: '',
    body: [
      'As such, I was bartering my way throughout the journey.This wouldn’t have been possible without the support of the Couch Surfing Community and the lovely people I met throughout my journey.I have plenty of stories to share.',
      '2019 - I was a waiter in various cities in India, then sold milk and chicken for an E-commerce website. I quit the job to be a caddy to a golfer.',
    ],
    images: [7],
    blockType: 'PL',
  },
  ...
  },
  {
    ...
    body: [
      '2021',
      'I trekked to Everest Base Camp, Nepal – once-in-a-lifetime experience and started a drop service business to assist folks around the country with videos, logos, websites, etc.',
      'A real good friend gave me “The Bitcoin Standard” to read and it just opened my eyes as to what is happening around us. I really related to this and was inspired to do my part.',
    ],
    images: [9],
    blockType: 'PL',
  },
  {
    ...
    body: [
      ...
      '2022 - 10 months later',
      'Hosted over 50 plus Bitcoin-only meetups in 300 days in 16 countries',
      'Traveled to India, UAE, Thailand, Cambodia, Singapore, Sri Lanka, Qatar, Kenya, Uganda, Rwanda, Tanzania, Malawi, Mozambique, Zimbabwe, Zambia & Botswana ',
      'Thank you, everyone. ',
      'Hugs,',
      'Paco',
    ],
  ...
  {
    key: 'journey10',
    title: 'Follow the Journey via:',
    body: [
      'It would be an honor to hear from you all and to share the journey as it progresses.',
      '**1. [Youtube](https://www.youtube.com/c/pacodelaindia)**',
      '**2. [Twitter](www.twitter.com/runwithbitcoin)**',
      '**3. [Instagram](https://www.instagram.com/runeverycity)**',
      '**4. [Telegram](https://t.me/runwithbitcoincommunity)**',
      '**5. [Blog - Substack](https://pacodelaindia.substack.com/)**',
    ],
    blockType: 'PL',
  },
];
...
const projectDetails: IProjectDetail = {
  ...
  ownerIntro:
    'My name is Paco, and I am crazy enough to want to travel to 40 countries only with Bitcoin.',
