...
const projectBlocks: IProjectBlock[] = [
	{
		...
		podcast: 'https://anchor.fm/geyser-fund/embed/episodes/The-Fight-for-the-US-Dollar-A-Bitcoin-Documentary-009-e1m5fbu',
		blockType: 'PL',
	},
	{
		key: 'description0',
	...
	},
	{
		...
		title: '',
		body: [
			'El Salvador has tried to break out of this US dollar domination through the adoption of Bitcoin as legal tender. It is about nation-state sovereignty, but also individual sovereignty. The decision was influenced by views on inflation, freedom, remittances, and an attempt to bank the unbanked. Following this decision, the government of El Salvador has been under scrutiny from the US government. Interviewing US and local government officials will help viewers understand the motivations behind both sides of the story.', 'The adoption of bitcoin has gained interest within the rest of the Central American region and countries like Guatemala and Honduras have publicly expressed their interest in bitcoin adoption. So far, no other country in the region has taken the next step. Local government officials that are involved in the decision making will be interviewed to explain the background.',
		],
		images: [2],
		blockType: 'PL',
	},
