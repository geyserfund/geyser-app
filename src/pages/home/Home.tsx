			...
			>
				...
				*/}
                ...
                Play a part by funding them on Geyser.
						...
						>
              Geyser is a global crowdfunding platform that helps Bitcoin
              builders and creators to fund their ideas.
						</Text>
						<HStack
							className={classes.pageStats}
							padding={isMobile ? '50px 20px' : '50px 70px'}
						>
							{summaryLoading ? (
								<>
									<VStack>
				...
				<VStack alignItems="flex-start" width="100%" spacing="0px">
					...
					<HStack width="100%" justifyContent="center">
						<SwipeLiveProject
							loading={loading}
							projects={[...activeProjects, previewProject]}
						/>
					</HStack>
				</VStack>
