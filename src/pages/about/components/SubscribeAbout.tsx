...
export const SubscribeAbout = () => {
  ...
  return (
    <VStack maxWidth={'764px'} width={'100%'} spacing={5} padding={3} alignItems={'center'}>
      <H1>{t('Subscribe to our newsletter')}</H1>
      <H3 color={'neutral.600'}>
        {t('Receive updates about exciting new projects, product updates and Geyser news.')}
      </H3>
      <TextInputBox
        ...
        error={error}
      />
      <Button isLoading={submitting} width={350} variant={'primaryGradient'} onClick={handleConfirm}>
        {t('Subscribe')}
      </Button>
    </VStack>
  )
