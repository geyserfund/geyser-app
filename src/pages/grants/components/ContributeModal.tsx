...
export const ContributeModal = ({ onLink }) => {
  ...
  const [formC, setFormC] = useState(true);
          ...
          <ModalBody>
            <Box display="flex" alignItems={'center'} gap={4}>
              ...
              <Text fontWeight={'400'} fontSize="10px">
                Scan this QR code to fund with Bitcoin on any wallet (on-chain
                or lightning)
              </Text>
            </Box>
          ...
          <ModalBody>
              ...
              <Box display="flex" alignItems={'center'} gap={3}>
                ...
                >
                  <Box
                    ...
                    py={2}
                    border={
                      amount === 100 ? '2px solid #20ECC7' : '2px solid #E9ECEF'
                    }
                    rounded="md"
                    fontWeight={'bold'}
            ...
            <Box>
              ...
              <Text fontWeight={'400'} fontSize="11px">
                ...
                Grant page drop the Image link in here and we will add it to the
                list of sponsors on the Grant page and the landing page
              </Text>
              <Textarea
                mt={3}
