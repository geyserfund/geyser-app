...
export const TopBanner = () => {
  ...
  return (
    ...
    >
      ...
      <Text textColor={colors.neutral900} justifyItems="center">
        Geyser is a global crowdfunding platform that helps Bitcoin creators
        change the world with their communities
      </Text>
      {summaryLoading ? (
        <HStack>
          <HStack>
        ...
        <HStack>
          <HStack>
            <Text fontWeight={500} textColor={colors.neutral900}>
              {summary.projectsCount}
            </Text>
            <Text textColor={colors.neutral700}>PROJECTS</Text>
          </HStack>
          <HStack>
            <Text fontWeight={500} textColor={colors.neutral900}>
              {summary.fundedTotal}
            </Text>
            <Text textColor={colors.neutral700}>SATS RAISED</Text>
          </HStack>
          <HStack>
            <Text fontWeight={500} textColor={colors.neutral900}>
              {summary.fundersCount}
            </Text>
            <Text textColor={colors.neutral700}>PLEB CONTRIBUTORS</Text>
          </HStack>
        </HStack>
      )}
      <ButtonComponent primary width={300} onClick={handleLaunch}>
        Launch your project
      </ButtonComponent>
    </VStack>
  );
